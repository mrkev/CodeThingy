var FirepadUserList = (function() {
  ...
  function FirepadUserList(ref, userId) {
    if (!(this instanceof FirepadUserList)) { return new FirepadUserList(ref, userId); }
  ...
  FirepadUserList.prototype.makeUserList_ = function() {
    return {
      'self'   : this.makeUserEntryForSelf_(),
      'others' : this.makeUserEntriesForOthers_()
    }
  };
  ...
  FirepadUserList.prototype.makeUserEntryForSelf_ = function() {
    ...
    console.log('MY USER REF'); console.log(myUserRef);

    //var this.userlist.color = '#000';
  ...
  FirepadUserList.prototype.makeUserEntriesForOthers_ = function() {
    ...
    */
    function updateChild(userSnapshot, prevChildName) {
      ...
      if (self.others[userId]) {
        delete self.others[userId];
      }
